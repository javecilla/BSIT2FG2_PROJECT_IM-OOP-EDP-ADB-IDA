...
public class MenuFries extends JFrame implements ActionListener {
    ...
    ImageIcon largeFIcon = new ImageIcon(getClass().getResource("/views/Images/fries/large fries.png"));
    ImageIcon mediumFIcon = new ImageIcon(getClass().getResource("/views/Images/fries/medium fries.png"));
    ImageIcon smallFIcon = new ImageIcon(getClass().getResource("/views/Images/fries/small fries.png"));
    
    ImageIcon backgroundIcon = new ImageIcon(getClass().getResource("/views/Images/fries/menu-Fries.jpg"));
    ...
    // Buttons
    JButton largeFButton = new JButton();
    JButton mediumFButton = new JButton();
    JButton smallFButton = new JButton();
    ...
    public void friesFrameConfig() {
        ...
        setupButton(largeFButton, largeFIcon);
        setupButton(mediumFButton, mediumFIcon);
        setupButton(smallFButton, smallFIcon);
        ...
        gridPanel.add(largeFButton);
        gridPanel.add(mediumFButton);
        gridPanel.add(smallFButton);
